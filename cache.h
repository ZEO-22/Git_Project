...
#define REFRESH_REALLY                   (1 << 0) 
#define REFRESH_UNMERGED                 (1 << 1) 
#define REFRESH_QUIET                    (1 << 2) 
#define REFRESH_IGNORE_MISSING           (1 << 3) 
#define REFRESH_IGNORE_SUBMODULES        (1 << 4) 
#define REFRESH_IN_PORCELAIN             (1 << 5) 
#define REFRESH_PROGRESS                 (1 << 6) 
#define REFRESH_IGNORE_SKIP_WORKTREE     (1 << 7) 
